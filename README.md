...
| Category | Skills |
|---|---|
| **n8n Automation** | Workflow design, API integrations, webhook triggers, Telegram/Google Sheets/RSS bots, AI-assisted pipelines |
| **API Integration** | REST APIs, JSON, webhooks, OAuth2, multi-service automation |
| **Network security** | Port scanning, traffic analysis, DNS filtering (AdGuard Home), firewall hardening |
| **Network infrastructure** | MikroTik RouterOS, LAN/SCS, routers & switches config, fault diagnostics |
...
| **Linux** | Kali Linux, live USB boot, GParted, Bash, tcpdump — no Windows dependency |
| **DNS hardening** | DoH (DNS-over-HTTPS), AdGuard Home, network-level filtering |
...
2018 – 2023      Network Technician · WinSERVICE Ukraine
                 ...
                 On-site field visits & installations
```
...
|-------------|--------|------|
| Introduction to Cybersecurity | Cisco NetAcad | [View PDF](https://drive.google.com/file/d/1az2_7ueMJT4zrpI_sEH-03zzrlsB3yTJ/view?usp=sharing) |
